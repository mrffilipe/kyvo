...
export interface paths {
    ...
    "/v{version}/Auth/subscribe": {
         ...
         * @description When the caller has an active auth session, freshly issued OAuth tokens may be included under `tokens`
         *     using RFC 6749 field names (`access_token`, `refresh_token`, etc.).
         */
        post: {
            parameters: {
                query?: never;
...
export interface components {
    schemas: {
        ...
        /** @description Response for SaaS tenant subscription, optionally including freshly issued OAuth tokens for the active session. */
        SubscribeTenantResponse: {
            ...
            tokens?: components["schemas"]["OidcTokenResponse"];
        };
        SwitchTenantRequest: {
            /** Format: uuid */
            tenantId: string;
