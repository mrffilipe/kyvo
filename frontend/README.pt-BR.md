...
| Firebase | `projectId`, `webApiKey`, `serviceAccount` | GoogleSocial | formulário na UI; `serviceAccount` = arquivo `.json` da conta de serviço Admin SDK (não é o `firebaseConfig` do app Web) |
