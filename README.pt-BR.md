...
```
backend/    API ASP.NET Core 8 (produto 2.0.0) — Clean Architecture (Domain / Application / Infrastructure / API)
frontend/   Painel admin SPA 2.0.0 — React 19 + MUI + React Router 7 + Vite
