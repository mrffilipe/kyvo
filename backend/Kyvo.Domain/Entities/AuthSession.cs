...
public sealed class AuthSession : BaseEntity
{
        ...
        string? ipAddress)
    {
        ...
        {
            throw new DomainValidationException(DomainErrorMessages.AuthSession.USER_ID_REQUIRED);
        }
    ...
    public void SwitchTenant(Guid tenantId, Guid membershipId)
    {
        ...
        {
            throw new DomainValidationException(DomainErrorMessages.AuthSession.TENANT_CONTEXT_INVALID);
        }
