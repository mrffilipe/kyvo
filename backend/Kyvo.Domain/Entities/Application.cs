...
public sealed class Application : BaseEntity
{
        ...
        string? heroSubtitle)
    {
        ...
        BrandingPrimaryColor = BrandingColor.NormalizeOrThrow(primaryColor, DomainErrorMessages.Application.BrandingPrimaryColorField);
        BrandingSecondaryColor = BrandingColor.NormalizeOrThrow(secondaryColor, DomainErrorMessages.Application.BrandingSecondaryColorField);
