    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (UnauthorizedApplicationException ex)
        {
            ...
            await WriteProblemAsync(
                ...
                ApiErrorMessages.UNAUTHORIZED_TITLE,
                ex.Message);
        }
        catch (ForbiddenApplicationException ex)
        {
            ...
            await WriteProblemAsync(
                ...
                ApiErrorMessages.FORBIDDEN_TITLE,
                ex.Message);
        }
        ...
        catch (InvalidClientException ex)
        {
            ...
            await WriteProblemAsync(
                context,
                HttpStatusCode.Unauthorized,
                ApiErrorMessages.INVALID_CLIENT_TITLE,
                ex.Message);
        }
        ...
        catch (AntiforgeryValidationException ex)
        {
            ...
            await WriteProblemAsync(
                ...
                HttpStatusCode.BadRequest,
                ApiErrorMessages.DOMAIN_VALIDATION_TITLE,
                ApiErrorMessages.Account.SESSION_EXPIRED_RETRY_LOGIN);
        }
