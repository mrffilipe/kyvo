...
public sealed class DistributedTenantResolutionCache : ITenantResolutionCache
{
    ...
    public DistributedTenantResolutionCache(IDistributedCache distributedCache) => _distributedCache = distributedCache;

    public Task InvalidateByIdentifierAsync(string identifier, CancellationToken ct = default)
    {
